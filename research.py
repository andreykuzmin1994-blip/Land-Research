...
def _print_phase1_status() -> None:
    ...
    print(
        "research.py — Phase 9: per-parcel snapshots + per-market strategy "
        "memos rendered as deterministic markdown from the scored parcel + "
        "market_context + flagged_items state. Phase 7+8 (scoring engine + "
        "4-gate actionability + 5-strategy fit) and Phase 6.1 (CoStar "
        "ingestion) remain in place. Experiment loop (Phase 10) not yet "
        "implemented."
    )
